...
int main() {
    ...
    // test capacity
    cout << "Capacity of x, y and z = " << static_cast<VectorList<double> *>(x)->capacity() << ", " << y.capacity() << ", " << z.capacity() << endl;

    // test size
    cout << "Initial size of x, y, and z = " << x->size() << ", " << y.size() << ", " << z.size() << endl;
    ...
    for (VectorList<int>::iterator i = y.end(); i != y.begin(); cout << *(--i) << "  ") {
    }
